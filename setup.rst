...
3. Compile the code
   ...
   In the command line, navigate to the directory containing the FUNWAVE :code:`Makefile`. Type the following:
   ...
   The executable file such as :code:`funwave` or :code:`mytvd` (specified in :code:`Makefile`) will be generated.   **Note: always use 'make clean' after modifying the makefile**.  
