...
where :math:`\theta` is the Shields parameter and :math:`\theta^b_{cr}` is the critical Shields parameter for bedload motion. In `Meyer-Peter and Muller (1948) <http://resolver.tudelft.nl/uuid:4fda9b61-be28-4703-ab06-43cdc2a21bd7>`_,  :math:`\theta^b_{cr} = 0.047`.
